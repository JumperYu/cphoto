...
public class ImgUtil {
	...
	public static void main(String[] args) {
		ImgUtil.composePic("D:/1.jpg",
				"http://t3.qlogo.cn/mbloghead/d387538f629cfb53c2b0/100",
				"D:/2.jpg", 53, 161);
	}
	...
	public static void composePic(Image backImage, Image headImage,
		...
		/*
		 * if (hasAlpha(backImage)) { alphaType = BufferedImage.TYPE_INT_ARGB; }
		 */

		// 画图
		BufferedImage backgroundImage = new BufferedImage(bwidth, bheight,
				alphaType);
	...
	public static void composePic(String backPicPath, String headPicUrl,
		...
		try {
			...
			backImage = ImgUtil.pressText("深水鱼的马甲", backImage, "微软雅黑",
					Font.BOLD, ImgUtil.String2Color("#FFFFFF"), 24,
					175 + (266 - ln) / 2, 188, 1);
			// 得分
			backImage = ImgUtil.pressText("100分", backImage, "华康海报体W12(P)",
					Font.LAYOUT_NO_LIMIT_CONTEXT,
					ImgUtil.String2Color("#FD6E10"), 22, 280, 233, 1);
			// 收益
			backImage = ImgUtil.pressText("85%", backImage, "迷你简凌波",
					Font.LAYOUT_NO_LIMIT_CONTEXT,
					ImgUtil.String2Color("#E60000"), 24, 368, 264, 1);
			// 称号
			int lc = ImgUtil.getLength("有股神潜力，万众膜拜！") * 32;
			backImage = ImgUtil
					.pressText("有股神潜力，万众膜拜！", backImage, "华康海报体W12(P)",
							Font.LAYOUT_NO_LIMIT_CONTEXT,
							ImgUtil.String2Color("#880000"), 32,
							(488 - lc) / 2, 310, 1);
			// 读取头像图片
	 ...
	 * @throws IOException
	 */
	public static BufferedImage pressText(String pressText, Image targetImg,
