...
public class SpyClient {
	...
	private static final int DEFAULT_SECONDS = 60 * 60 * 24;
	...
	public static void set(String key, String value) {
		...
		try {
			log.debug(b.get() ? String.format("set key:%s=%s success", key,
					value) : String.format("set key:%s=%s fault", key, value));
	...
	public static boolean set(String key, String value, int seconds) {
		...
		try {
			ret_stat = b.get();
			log.debug(String.format("set key:%s=%s %s", key, value,
	...
	public static Object get(String key) {
		...
		log.debug(String.format("get key:%s=%s", key, b != null ? b.toString()
				: "null"));
		return b;
	}
